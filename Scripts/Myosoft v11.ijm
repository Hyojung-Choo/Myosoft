...
r run("Set Scale...", "distance="+pix+" known="+mic+" pixel=1 unit=micron"); // the known distance and units may change based on image
...
r run("Set Scale...", "distance="+pix+" known="+mic+" pixel=1 unit=micron"); 
...
print("Biopsy Size: "+biopSz+"µm^2 --- Cells per µm^2: "+cpmms+"µm^2 --- Proportion IIb "+Proportion_IIb+" --- Proportion IIa "+Proportion_IIa+" --- Proportion I "+Proportion_I+" --- Proportion IIx "+Proportion_IIx+"");
selectWindow("Log");
